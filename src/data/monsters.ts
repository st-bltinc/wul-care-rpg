...
// weaknessTag に対応する武器（ITツール）で「特効(2倍)」。
// ============================================================
...
export const MONSTERS: Monster[] = [
  ...
  // ---- 施設全体（ラスボス） ----
  {
    ...
    hp: 66, atk: 11, weaknessTag: 'handover', weaknessHint: 'ChatGPT＝AIサポート端末',
  ...
  },
  {
    ...
    hp: 220, atk: 24, weaknessTag: 'handover', weaknessHint: 'ChatGPT＝AIサポート端末',
...
const MID_BOSSES: Monster[] = [
  {
    ...
    hp: 40, atk: 6, weaknessTag: 'claim', weaknessHint: 'Gmail＝伝達の羽ペン',
  ...
  },
  {
    ...
    hp: 50, atk: 7, weaknessTag: 'record', weaknessHint: 'Googleドキュメント＝共同編集の書',
  ...
  },
  {
    ...
    hp: 62, atk: 9, weaknessTag: 'overwork', weaknessHint: 'Googleカレンダー＝時のコンパス',
  ...
  },
  {
    ...
    hp: 72, atk: 10, weaknessTag: 'sharing', weaknessHint: 'Google Drive＝共有キー',
  ...
  },
  {
    ...
    hp: 84, atk: 12, weaknessTag: 'record', weaknessHint: 'Googleドキュメント＝共同編集の書',
  ...
  },
  {
    ...
    hp: 96, atk: 13, weaknessTag: 'record', weaknessHint: 'スプレッドシート＝集計の杖',
  ...
  },
  {
    ...
    hp: 108, atk: 15, weaknessTag: 'remote', weaknessHint: 'Zoom／Google Meet＝遠隔通信リング・招集の水晶',
  ...
  },
  {
    ...
    hp: 130, atk: 17, weaknessTag: 'handover', weaknessHint: 'ChatGPT＝AIサポート端末',
